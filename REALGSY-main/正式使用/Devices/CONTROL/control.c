#include "control.h"
int Target_velocity1=0; //要用负的
int Target_velocity2=0;//要用负的
...
void ps2go(void)
{	
		if(PS2_LY>=0&&PS2_LY<=126)
		{
				Target_velocity1=-20*(126-PS2_LY);
				Target_velocity2=-20*(126-PS2_LY);
				Target_velocity3=20*(126-PS2_LY);
				Target_velocity4=-20*(126-PS2_LY);
				delay_us(10);
		}
		else if(PS2_LY<=255&&128<=PS2_LY)
			{
				Target_velocity1=20*(PS2_LY-128);
				Target_velocity2=20*(PS2_LY-128);
				Target_velocity3=-20*(PS2_LY-128);
				Target_velocity4=20*(PS2_LY-128);
				delay_us(10);
		}
			else if(PS2_LX==0)
			{
				Target_velocity1=2000;
				Target_velocity2=-2000;
				Target_velocity3=2000;
				Target_velocity4=2000;
				delay_us(10);
		}
			else if(PS2_LX==255)
			{
...
void changemode (void)
{
	if(runrun == 3)
	{
		if(red3 == 1&&red4 == 1&&red5 == 1&&red6 == 0)
		{
			Target_velocity1=-850;
			Target_velocity2=-800;
			Target_velocity3= 800;
			Target_velocity4=-800;
		}
		else if(red1==0&&red2==1&&red3 == 1&&red4 == 1&&red5 == 1&&red6 == 0)
		{
			Target_velocity1=-800;
			Target_velocity2=-500;
			Target_velocity3= 800;
			Target_velocity4=-500;
		}
		else if(red1==1&&red2==1&&red3 == 1&&red4 == 1&&red5 == 1&&red6 == 1 )
		{
        Target_velocity1=-300;
				Target_velocity2=300;
				Target_velocity3=300;
				Target_velocity4=300;
		}
		else
		{
			 Target_velocity1=300;
	...
	else if(runrun == 4)
	{
		...
		{
			 Target_velocity1=-500;
				Target_velocity2=-800;
				Target_velocity3=600;
				Target_velocity4=-700;
		}
	}
	else if(runrun == 1)
	{
...
void redgo (void)
{
		Target_velocity1=-700;
			Target_velocity2=-800;
			Target_velocity3= 700;
			Target_velocity4=-800;
		delay_ms(1000);
		Target_velocity1=0;
			Target_velocity2=0;
...
void CATCH (void)
{
	TIM_SetCompare1(TIM1,1400);//55°=499+10.811*55=1093
	TIM_SetCompare2(TIM1,2400);
}
void RELEASE (void)
{
	TIM_SetCompare1(TIM1,2000);//55°=499+10.811*55=1093
